  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <div className="mx-auto max-w-[1200px] px-3 md:px-6 py-4">
        ...
        <style>{`
          /* ====== IMPORTANT: no zoom / no transform scale ====== */
          .sheetWrap{
            width: 100%;
            overflow: visible;
          }
          ...
          /* ✅ มือถือ: ลด padding+ตัวหนังสือนิดหน่อย ให้เต็มจอขึ้น */
          @media (max-width: 420px) {
            .a4 { padding: 10px; font-size: 12px; }
            .hMain { font-size: 16px; }
            .hSub  { font-size: 12px; }
            .mini th, .mini td { font-size: 11px; }
          }
          ...
          @media print {
            ...
            .sheet { max-width: none !important; width: 210mm !important; }
